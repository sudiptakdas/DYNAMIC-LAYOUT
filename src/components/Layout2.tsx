...
const Layout2: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    _id: '663dddf4b44b03e5b185c5f4',
    componentType: 'Label2',
    addCount: 0,
    updateCount: 0,
    title: '',
    content: '',
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            'https://dynamic-layout-be.vercel.app/api/663dddf4b44b03e5b185c5f4'
          );
  ...
  return (
    <div className='bg-red-200 border border-red-700 w-full h-full p-6'>
      <div className=' flex justify-between mb-3'>
        ...
        <div>
          <button className='bg-yellow-200 p-2 rounded-xl cursor-none cancel-drag'>
